...
export const VIEWS = ['simple', 'complex', 'timeline', 'about', 'settings'];
...
export function setView(v) {
  ...
  view.current = v;
  document.body.classList.remove('view-simple', 'view-complex', 'view-timeline', 'view-about', 'view-settings');
